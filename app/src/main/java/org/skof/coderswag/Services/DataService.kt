package org.skof.coderswag.Services

import org.skof.coderswag.Model.Category
import org.skof.coderswag.Model.Product

/**
 * Created by regis on 11/19/2017.
 */
object DataService {
    ...
    val hoodies = listOf(
            Product("Devslopes Hooodie Gray", "$28", "hoodie01"),
            Product("Devslopes Hooodie Red", "$30", "hoodie02"),
